	system u0 (
		.acl_iface_d5m_config_I2C_SDAT       (<connected-to-acl_iface_d5m_config_I2C_SDAT>),       //        acl_iface_d5m_config.I2C_SDAT
		.acl_iface_d5m_config_I2C_SCLK       (<connected-to-acl_iface_d5m_config_I2C_SCLK>),       //                            .I2C_SCLK
		.acl_iface_d5m_config_exposure       (<connected-to-acl_iface_d5m_config_exposure>),       //                            .exposure
		.acl_iface_led_pio_export            (<connected-to-acl_iface_led_pio_export>),            //           acl_iface_led_pio.export
		.acl_iface_pushbuttons_export        (<connected-to-acl_iface_pushbuttons_export>),        //       acl_iface_pushbuttons.export
		.acl_iface_vga_CLK                   (<connected-to-acl_iface_vga_CLK>),                   //               acl_iface_vga.CLK
		.acl_iface_vga_HS                    (<connected-to-acl_iface_vga_HS>),                    //                            .HS
		.acl_iface_vga_VS                    (<connected-to-acl_iface_vga_VS>),                    //                            .VS
		.acl_iface_vga_BLANK                 (<connected-to-acl_iface_vga_BLANK>),                 //                            .BLANK
		.acl_iface_vga_SYNC                  (<connected-to-acl_iface_vga_SYNC>),                  //                            .SYNC
		.acl_iface_vga_R                     (<connected-to-acl_iface_vga_R>),                     //                            .R
		.acl_iface_vga_G                     (<connected-to-acl_iface_vga_G>),                     //                            .G
		.acl_iface_vga_B                     (<connected-to-acl_iface_vga_B>),                     //                            .B
		.acl_iface_vga_pll_d5m_clk_clk       (<connected-to-acl_iface_vga_pll_d5m_clk_clk>),       //   acl_iface_vga_pll_d5m_clk.clk
		.acl_iface_vga_pll_ref_clk_clk       (<connected-to-acl_iface_vga_pll_ref_clk_clk>),       //   acl_iface_vga_pll_ref_clk.clk
		.acl_iface_vga_pll_ref_reset_reset   (<connected-to-acl_iface_vga_pll_ref_reset_reset>),   // acl_iface_vga_pll_ref_reset.reset
		.acl_iface_video_in_PIXEL_CLK        (<connected-to-acl_iface_video_in_PIXEL_CLK>),        //          acl_iface_video_in.PIXEL_CLK
		.acl_iface_video_in_LINE_VALID       (<connected-to-acl_iface_video_in_LINE_VALID>),       //                            .LINE_VALID
		.acl_iface_video_in_FRAME_VALID      (<connected-to-acl_iface_video_in_FRAME_VALID>),      //                            .FRAME_VALID
		.acl_iface_video_in_pixel_clk_reset  (<connected-to-acl_iface_video_in_pixel_clk_reset>),  //                            .pixel_clk_reset
		.acl_iface_video_in_PIXEL_DATA       (<connected-to-acl_iface_video_in_PIXEL_DATA>),       //                            .PIXEL_DATA
		...
		.acl_iface_adc_sclk                  (<connected-to-acl_iface_adc_sclk>),                  //               acl_iface_adc.sclk
		.acl_iface_adc_cs_n                  (<connected-to-acl_iface_adc_cs_n>),                  //                            .cs_n
		.acl_iface_adc_dout                  (<connected-to-acl_iface_adc_dout>),                  //                            .dout
		.acl_iface_adc_din                   (<connected-to-acl_iface_adc_din>),                   //                            .din
		.acl_iface_av_config_SDAT            (<connected-to-acl_iface_av_config_SDAT>),            //         acl_iface_av_config.SDAT
		.acl_iface_av_config_SCLK            (<connected-to-acl_iface_av_config_SCLK>)             //                            .SCLK
	);
