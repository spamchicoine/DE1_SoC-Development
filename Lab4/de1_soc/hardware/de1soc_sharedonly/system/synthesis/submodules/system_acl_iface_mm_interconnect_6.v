...
module system_acl_iface_mm_interconnect_6 (
		...
		output wire [9:0]  Onchip_SRAM_s2_address,                              //                                Onchip_SRAM_s2.address
	...
	wire   [83:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> VGA_Subsystem_pixel_dma_master_agent:rp_data
	...
	wire   [83:0] vga_subsystem_pixel_dma_master_agent_cp_data;                                      // VGA_Subsystem_pixel_dma_master_agent:cp_data -> router:sink_data
	...
	wire   [83:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> Onchip_SRAM_s2_cmd_width_adapter:in_data
	...
	wire   [83:0] onchip_sram_s2_rsp_width_adapter_src_data;                                         // Onchip_SRAM_s2_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	system_acl_iface_mm_interconnect_6_cmd_demux rsp_demux (
		.clk                (config_clk_out_clk_clk),                             //       clk.clk
		.reset              (Onchip_SRAM_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
